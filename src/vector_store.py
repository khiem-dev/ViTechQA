...
def retrieve(collection, query, top_k, distance_threshold):
    """
    ...
    filtered = [doc for doc, dist in zip(documents, distances) if dist < distance_threshold]
    
    return filtered if filtered else ["Không tìm thấy thông tin liên quan trong tài liệu"]  # list các chunks liên quan
...
if __name__ == "__main__":
    ...
    top_chunks = retrieve(collection, query, top_k=3, distance_threshold=0.6)
